            ...
            <div class="w-full mb-1">
                ...
                <div class="sm:flex">
                    <div class="items-center hidden mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 dark:divide-gray-700">
                        <form class="lg:pr-3" action="{{ route('admin.produk.produk.index') }}" method="GET">
                    ...
                    <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                        ...
                        <button type="button" data-modal-target="import-modal" data-modal-toggle="import-modal" class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700">
                                        ...
                                        <form action="{{ route('admin.produk.import') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <input type="file" name="file" id="file" required
                                                    class="w-full px-3 py-2 mt-1 text-sm text-gray-900 bg-white border rounded-lg focus:outline-none focus:ring focus:ring-primary-300">
                                            </div>
                        ...
                        <a href="{{ route('admin.produk.export-produk', ['search' => request()->get('search')]) }}" class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700">
                            <svg class="w-5 h-5 mr-2 -ml-1 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                @else
                                    ...
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td class="p-4 space-x-2 whitespace-nowrap text-center align-middle">
                                            <a href="{{ route('admin.produk.produk.show', $prod->id) }}" 
        ...
        <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full" id="add-prod-modal">
            <div class="relative w-full h-full max-w-2xl px-4 md:h-auto">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                    ...
                    <div class="p-6 space-y-6">
                        <form action="{{ route('admin.produk.produk.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
        ...
        <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full" id="edit-prod-modal-{{ $prod->id }}">
            <div class="relative w-full h-full max-w-2xl px-4 md:h-auto">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                    ...
                    <div class="p-6 space-y-6">
                        <form action="{{ route('admin.produk.produk.update', $prod->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-3">
            ...
            <div class="relative w-full h-full max-w-md px-4 md:h-auto">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                    ...
                    <div class="p-6 pt-0 text-center">
                        ...
                        <form action="{{ route('admin.produk.produk.destroy', $prod->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
