    ...
    <div class="container px-4 mx-auto xl:px-0">
        <div class="grid gap-12 xl:grid-cols-6 xl:gap-24">
            <div class="col-span-2">
                ...
                <p class="max-w-lg mt-4 text-gray-500 dark:text-gray-400">Stockify adalah aplikasi web yang dirancang untuk membantu bisnis,
                    khususnya yang memiliki gudang, dalam mengelola stok barang secara efisien dan akurat.</p>
            </div>
            <div>
        ...
        <span class="block text-center text-gray-600 dark:text-gray-400">©2024<span></span> <a target="_blank" rel="noreferrer">Stockify</a>. All Rights Reserved.</span>
    </div>
</footer>