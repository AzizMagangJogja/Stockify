                        ...
                        <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="{{ route('staff.stock.penerimaan.index') }}" class="ml-2 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white flex items-center">
        ...
        <div class="sticky bottom-0 right-0 items-center w-full p-4 bg-white border-gray-200 sm:flex sm:justify-between dark:bg-gray-800 dark:border-gray-700">
            <div class="flex items-center mb-4 sm:mb-0">
                ...
                <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                    ...
                    of <span class="font-semibold text-gray-900 dark:text-white">{{ $masuk->total() }}</span> Barang Masuk
                </span>
            </div>
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                    <div class="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-700">
                        <h3 class="text-xl font-semibold dark:text-white">
                            Konfirmasi Transaksi Penerimaan Barang
                        </h3>
                    ...
                    <div class="p-6 space-y-6">
                        <form action="{{ route('staff.stock.penerimaan.update', $terima->id) }}" method="POST">
                            @csrf
                            @method('PUT')
