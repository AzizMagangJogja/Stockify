<footer class="p-4 my-6 mx-4 bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 xl:p-8 dark:bg-gray-800">
    ...
    <div class="flex space-x-6 sm:justify-center">
        ...
        <a href="https://www.instagram.com/sevenincjogja" class="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white" target="_blank">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <a href="https://id.linkedin.com/company/seven-inc-jogja" class="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white" target="_blank">
...
<p class="my-10 text-sm text-center text-gray-500">
    &copy;{{ date('Y') }} <a href="{{ config('app.homepage') }}" class="hover:underline" target="_blank">Stockify.com</a>. All rights reserved.
</p>
